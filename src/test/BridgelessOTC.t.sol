    ...
    BridgelessStructs
{
    ...
    function _callPermit(IERC2612 permitToken, address sender, address spender, Signature memory permit) internal {
        permitToken.permit(sender, spender, 1e16, type(uint256).max, permit.v, permit.r, permit.s);
    }
}
